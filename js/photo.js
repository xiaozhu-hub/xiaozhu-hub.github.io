$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="photo.html" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;">我的祝福！</a>');
            $('.begin').fadeIn();
            return;
        }
    };
    ...
    function animateFct(i) {
        ...
        li.eq(i).find('photo').css({width: '250px', height: '350px'})
        li.eq(i).show();
